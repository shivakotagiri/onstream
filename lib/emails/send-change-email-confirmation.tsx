...
export const sendChangeEmailConfirmationRequest = async ({ user, url, email }: ChangeEmailProps) => {
    return sendEmail({
        to: email,
        ...
        html: `
            ...
            <body style="margin:0; padding:0; background-color:#F2F2F2; color:#1a1a1a;">
                ...
                <div style="display:none; font-size:1px; color:#333333; line-height:1px; max-height:0px; max-width:0px; opacity:0; overflow:hidden;">
                    Action Required: Please confirm your request to change your email address.
                </div>
                                ...
                                <tr>
                                    <td class="content" style="background-color:#ffffff; padding: 48px; border-radius: 16px; box-shadow: 0 2px 8px rgba(0,0,0,0.04);">
                                            ...
                                            <tr>
                                                <td align="center" style="padding-bottom: 24px;">
                                                    <div style="background-color: #F7F7F7; border-radius: 50%; width: 64px; height: 64px; line-height: 64px;">
                                                        <img src="https://cdn-icons-png.flaticon.com/512/9446/9446864.png" width="24" height="24" alt="Refresh Icon" style="vertical-align: middle; opacity: 0.7;">
                                                    </div>
                                                </td>
                                            </tr>
                                        </table>
                                        ...
                                        <h1 style="margin: 0 0 16px; font-size: 22px; font-weight: 600; text-align: center; color: #000000; letter-spacing: -0.5px;">
                                            Confirm email change to ${email}
                                        </h1>

                                        <p style="margin: 0 0 24px; font-size: 15px; line-height: 26px; text-align: center; color: #555555;">
                                            Hi <strong>${user.name || "there"}</strong>,<br>
                                            We received a request to change the email address associated with your onStream account.
                                        </p>
                                        <p style="margin: 0 0 32px; font-size: 15px; line-height: 26px; text-align: center; color: #555555;">
                                            To confirm this change and verify your new address, please click the button below.
                                        </p>
                                ...
                                <tr>
                                    <td align="center" style="padding-top: 24px;">
                                        <p style="margin: 0; font-size: 12px; line-height: 20px; color: #999999;">
                                            <strong>Security Note:</strong> If you did not request this change,<br>please contact support immediately.
                                        </p>
